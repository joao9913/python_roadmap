...
class FibonacciIterator():
    ...
    def __next__(self):
        ...
        if self.position <= 1:
            self.current_number = self.position
            self.previous_number = 0
            self.position += 1
            return self.current_number

        temp_number = self.previous_number
        self.previous_number = self.current_number
        self.current_number = self.current_number + temp_number
        self.position += 1
        return self.current_number


fibonacci_iter = FibonacciIterator(6)
...
range_like = RangeLike(2, 10, 2)

for num in range_like:
    print(num)
